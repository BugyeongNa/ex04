...
<body>
    ...
    <div class="main">
        <div class="container">
            <div>
                <h2 align="center" class="mt-3 p-3 border rounded-2">회원가입</h2>
            </div>
            <div class=" border p-3 m-3 m-auto form-control">
                <form action="${ctxPath}/sqlmember/insertMember.do" id="updateForm">
                    <div class="mb-3">
                        <label  class="form-label">ID</label>
                        <input type="text" name="id" value="${member.id}" class="form-control" id="id" >
                        <input type="button" id="idChk" class="" value="중복체크">
                    </div>
                    ...
                    <div class="messagePhone text-danger"></div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3 d-flex justify-content-between">
                        ...
                        <a href="${ctxPath}/sqlmember/listMember.do" class="btn btn-secondary">목록</a>
                    </div>
                </form>
            </div>
        </div>
    	...
    	$(function(){
    		...
    		$('#idChk').click(function(){
    			...
    			$.ajax({
    				type: 'post',
    				async: false,
    				url: "/web01/sqlmember/checkId.do",
    				dataType: "text",
    				data: { id: send_id},
