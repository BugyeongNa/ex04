...
<body>
    ...
    <div class="main">
        <div class="container ">
                ...
                <c:choose>
                	...
                	<c:when test="${memberList!=null}">
		                ...
		                <tr>
		                    ...
		                    <td>
		                     <a href="${ctxPath}/tmemView.do?id=${mem.id}"  
        	...
        	<a href="${ctxPath}/tmemRegister.do" class="link-success link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">회원가입하기</a>
        </div>
    </div>
</body>
</html>