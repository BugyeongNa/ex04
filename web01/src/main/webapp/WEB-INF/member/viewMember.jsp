...
<body>
        ...
        <div class="container m-auto mt-5">
            <div class="justify-content-center form-control">
            ...
            <div class="m-auto">
                <div class="viewMember border p-4 m-3">
                    ...
                    <div class="row d-flex">
                        <div class="col-md-6">
                            <a href="${ctxPath}/tmemModify.do?id=${member.id}" class="btn btn-success btn-sm m-1">수정</a>
                            <a href="${ctxPath}/tmemDelete.do?id=${member.id}" class="btn btn-warning btn-sm m-1" id="delBtn">삭제</a>
                            <input type="hidden" value="${member.id}" id="memberId">
                            <input type="hidden" value="${ctxPath}" id="path">
                        </div>
                        <div class="col-md-2">
                            <a href="${ctxPath}/tmemList.do" class="btn btn-dark btn-sm m-1">목록</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript">
    	$(function(){
    		...
    		$('#delBtn').click(function(e){
    			...
    			if (isDelete){
    				location.href=path+"/tmemDelete.do?id="+id;
    			}
    		});
    	});
    </script>
