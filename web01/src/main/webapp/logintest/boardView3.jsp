...
<body>
            ...
            <div class="w-75 m-auto">
                <div class="mb-3 row">
                  ...
                  <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" readonly name="id" class="form-control-plaintext border rounded-1 p-2" id="id" value="test07">
                    </div>
                  </div>
                  <div class="mb-3 row">
                    <label for="title" class="col-sm-2 col-form-label">제목</label>
                    <div class="col-sm-10">
                      <input type="text" readonly name="title" class="form-control-plaintext rounded-1 p-2" id="title" value="마지막 테스트글입니다.">
                    </div>
                  </div>
                  <div class="mb-3 row">
                    <label for="content" class="col-sm-2 col-form-label">내용</label>
                    <div class="col-sm-10">
                      <textarea rows="10" readonly name="content" class="form-control-plaintext border rounded-1 p-2" id="content">테스트 내용입니다. 많은 기능도 추가할 예정입니다...</textarea>
                    </div>
                  </div>
                  ...
                  <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" readonly name="writedate" class="form-control-plaintext border rounded-1 p-2" id="writedate" value="2023-05-25">
                    </div>
                  </div>
                   <hr>
            </div>
    ...
    function modify() {
			location.href = "/web01/logintest/boardModify3.jsp"
		}
    	function reply() {
        alert("준비중입니다..")
		}
