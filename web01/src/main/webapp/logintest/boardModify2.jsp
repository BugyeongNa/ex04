            ...
            <div class="w-75 m-auto">
                <input type="hidden" name="articleNO" value="${articleNO}">
                  <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="id" class="form-control border rounded-1 p-2" id="id" placeholder="아이디" value="test04">
                    </div>
                  </div>
                  <div class="mb-3 row">
                    <label for="title" class="col-sm-2 col-form-label">제목</label>
                    <div class="col-sm-10">
                      <input type="text" name="title" class="form-control border rounded-1 p-2" id="title" placeholder="제목" value="두번째 테스트글입니다.">
                    </div>
                  </div>
                  <div class="mb-3 row">
                    <label for="content" class="col-sm-2 col-form-label">내용</label>
                    <div class="col-sm-10">
                      <textarea rows="10" name="content" maxlength="4000" class="form-control border rounded-1 p-2" id="content">테스트 내용입니다. 나중에 서버도 연결하고...</textarea>
                    </div>
                  </div>
                  <div class="mb-3 row">
    ...
    <script>
      ...
      function cancel(){
    	  if(confirm("글 수정을 취소하시겠습니까?")){
     		location.href = "/web01/logintest/boardView2.jsp"
        }
      }
        function save(){
