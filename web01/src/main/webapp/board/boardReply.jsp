...
<c:set var="parentNO" value="<%=request.getParameter(\"parentNO\") %>"/>
...
<body>
    <div class="main">
        <div class="container mt-5">
            ...
            <!--  업로드(이미지파일) 기능이 포함된 form -->
             <form action="${ctxPath}/boardlist/board/boardReplyAdd.do" enctype="multipart/form-data" method="post">
            <div class="w-75 m-auto">
                <h4 class="text-center">답글 쓰기</h4>
                <hr>
            </div>
            <div class="w-75 m-auto">
            ...
            <div class="w-75 m-auto">
                <div class="d-flex justify-content-between mb-3">
                    <div class="col-md-8">
                        <button type="button" class="btn btn-outline-danger btn-sm" onclick="cancel()">취소</button>
                    </div>
	...
	function cancel() {
		location.href = "${ctxPath}/boardlist/boardView.do?articleNO=${parentNO}"
	}
    </script>
</body>
</html>